...
/**
 * Class TastesAndPrefs
 * @package Bananacode\Kip\Setup\Patch\Data
 */
class TastesAndPrefs implements DataPatchInterface
{
    const ATTRIBUTE_CODE = 'tastes_prefs';

    const ATTRIBUTE_TYPE = 'text';

    const ATTRIBUTE_INPUT = 'textarea';

    const ATTRIBUTE_LABEL = 'Tastes and preferences';
