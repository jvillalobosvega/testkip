...
export const kipCartHtml = (cart) => {
    ...
    return `<div class="block-content">
                ...
                <span class="express-left">Express máx:  `+kippingConfig.flash+`</span>
                <br/>
                <span class="flash-left">Flash máx: </span>

                <div data-action="scroll" class="minicart-items-wrapper">
                    <ol id="mini-cart" class="minicart-items">
                        ${Object.keys(cart).map(item => {
                            return cart[item].q > 0 && cart[item].s=="inStock" ?
                                `<li kip-stock="${cart[item].s}" kip-sort="${cart[item].ts}" class="item product product-item kiptem-id-${item}" data-kip="${item}" data-role="product-item">
                                                            <div class="product">
...
export const kipImpulseHtml = (impulse,impulsev2) => {
    ...
    return `<h4 class="bold-18" style="margin:0px !important;" >¿Necesitás algo más?</h4>            
            <div class="w3-container" style="height: calc(100vh - 173px);">
            <div class="w3-row">
