    ...
    public function comment($data)
    {
        ...
        if ($frontendUser || $adminRequest) {
            ...
            if ($order) {
                ...
                // $cupones = ":tickets: : N/D";
                // try{
                //     $client = new Client('https://kip-logistic.azurewebsites.net');
                //     $request = $client->newRequest('/coupon/'. $order->getCouponCode());
                //     $response = $request->getResponse();
                //     echo $response->getParsedResponse();                    
                //     $json = json_decode($response, true);
                    
                //     if (str_contains($json['description'],"REFERRALS")){
                //         $this->_bananaNotify->discord('errors', ":tickets: :tickets: :partying_face: :partying_face: Se ha utilzado un código de referidos en la orden: ".$order->getId(), 'CUPÓN DE REFERIDO');            
                //         $this->_bananaNotify->discord('errors', $cupones, 'CUPÓN DE REFERIDO');            
                //     }
                // } catch (\Exception $e) {  
                ...
                //     $cupones =  ":tickets: :" . $order->getCouponDescription();
                //     $this->_bananaNotify->discord('sales',  $cupones, 'Nueva Orden');                
                //     if (str_contains($cupones,"REFERRALS")){
                //         $this->_bananaNotify->discord('errors', ":tickets: :tickets: :partying_face: :partying_face: Se ha utilzado un código de referidos en la orden: ".$order->getId(), 'CUPÓN DE REFERIDO');            
                //         $this->_bananaNotify->discord('errors', $cupones, 'CUPÓN DE REFERIDO');            
                //     }
                //     // 
                ...
                // }
                // try {                    
                //     $cupones =  ":tickets: :" . $order->getCouponName();
                //     $this->_bananaNotify->discord('sales',  $cupones, 'Nueva Orden');                
                //     if (str_contains($cupones,"REFERRALS")){
                //         $this->_bananaNotify->discord('errors', ":tickets: :tickets: :partying_face: :partying_face: Se ha utilzado un código de referidos en la orden: ".$order->getId(), 'CUPÓN DE REFERIDO');            
                //         $this->_bananaNotify->discord('errors', $cupones, 'CUPÓN DE REFERIDO');            
                ...
                // }
                // try {                    
                //     $cupones =  ":tickets: :" . $order->getCouponLabel();
                //     $this->_bananaNotify->discord('sales',  $cupones, 'Nueva Orden');                
                //     if (str_contains($cupones,"REFERRALS")){
                //         $this->_bananaNotify->discord('errors', ":tickets: :tickets: :partying_face: :partying_face: Se ha utilzado un código de referidos en la orden: ".$order->getId(), 'CUPÓN DE REFERIDO');            
                //         $this->_bananaNotify->discord('errors', $cupones, 'CUPÓN DE REFERIDO');            
