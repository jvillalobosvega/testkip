...
class OrderRepository
{
    ...
    public function afterGet(OrderRepositoryInterface $subject, OrderInterface $order)
    {
        ...
        $coupon = $order->getData(self::COUPON);
        $qtyOrdered = $order->getData(self::QTY);
        ...
        $extensionAttributes->setCouponCode($coupon);
        $extensionAttributes->setTotalQtyOrdered($qtyOrdered);
