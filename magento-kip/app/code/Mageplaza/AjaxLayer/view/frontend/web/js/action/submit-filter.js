...
define(
    ...
    function ($, storage, loader, mage) {
        ...
        var productContainer = $('#layer-product-list'),
            layerContainer = $('.layered-filter-block'),
            quickViewContainer = $('#mpquickview-popup'),
            categoryView = $('.category-view'),
            categoryTitle = $('#page-title-heading span');
        ...
        return function (submitUrl, isChangeUrl) {
            ...
            return storage.post(submitUrl, data).done(
                function (response) {
                    ...
                    if (response.image) {
                        categoryView.html(response.image);
                    }
                    if (response.title) {
                ...
                function () {
                    ...
                    var filterCurrent = $('.layered-filter-block .filter-current .items .item .filter-value');
